...
Каждая задача должна иметь: id (US-001...), title, description, acceptanceCriteria (список условий), priority (1-10), passes (false по умолчанию), blocked (false по умолчанию) и notes (пустая строка).
